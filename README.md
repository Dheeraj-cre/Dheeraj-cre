...
- 🔗 [Movie Search App (Live)](https://movierateing.vercel.app/):React-based movie search application with real-time API integration, dark/light mode, and a responsive, user-friendly UI.



##  Skills
`HTML` `CSS` `JavaScript` `React.js` `Node JS` ` REST APIs` `MYSQL` `Git` `Responsive Design`
